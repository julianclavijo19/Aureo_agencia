...
export function About() {
  ...
  return (
    <section id="about" className="py-32 bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-slate-950 dark:via-slate-900/50 dark:to-slate-950 overflow-hidden">
