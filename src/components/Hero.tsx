    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 text-center py-32">
        ...
        >
          ...
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 text-blue-300 rounded-full text-sm backdrop-blur-sm">
          ...
          <h1 className="text-white text-5xl md:text-7xl lg:text-8xl tracking-tight max-w-5xl mx-auto">
        ...
        <motion.p
          ...
          className="text-blue-100 text-lg md:text-xl lg:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed"
        >
          Creatividad, estrategia y tecnología unidas para llevar tu marca al siguiente nivel. Nuevo look. Misma esencia.
        </motion.p>
        ...
        >
          <motion.button
            ...
            className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-full overflow-hidden shadow-lg shadow-blue-500/30"
          ...
          <motion.button
            className="group px-8 py-4 border-2 border-white/20 text-white rounded-full hover:bg-white/5 backdrop-blur-sm transition-all flex items-center gap-2 text-lg"
